...
%
%  "KevBedoya" is confirmed current: the account was renamed from KevinB88, and
%  GitHub now redirects the old course-repo URL to the new one.  Older documents
%  in this repo still print the KevinB88 URL; those links continue to work via
%  that redirect.  An incorrect handle here would silently block every
%  submission, so verify it still resolves before each distribution.
%
