...
\title{\vspace{-1.2cm}\textbf{\sffamily MATH 231 -- Applied Linear Algebra}\\[4pt]
       {\large\sffamily Lecture 1 \textbullet\ Vectors: Magnitude, Direction,
        and the Geometry of $\mathbb{R}^{2}$}\\[2pt]
...
the \emph{same} vector; and say what it means for two vectors to be parallel or
orthogonal, in terms of the angle $\theta$ between them.
...
\emph{inner product}, and it is the next thing we construct. It will collapse
the whole table above into arithmetic: in particular, testing two vectors for
orthogonality will become a single multiplication-and-addition, with no
