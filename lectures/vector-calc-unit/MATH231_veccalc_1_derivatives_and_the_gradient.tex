...
%
%  STATUS: complete.  Sections 1-8.  The unit continues; the closing
%  Looking-ahead of Sec. 8.2 is the hinge.
%
...
gradient points and why that matters; and write the linear approximation of a
function of one variable and of $n$ variables.
...
flat object requires a second derivative, which in $n$ dimensions will be a
