...
%
%  WITHIN the computational unit, numbering then runs CONTINUOUSLY across parts,
%  matching the vector unit's scheme:
%
...
%
%  Parts 2 and 3 therefore begin with \setcounter{section}{...}.  Both cite back
%  into this part heavily -- Sec. 1.1 and 1.4 for the cost of a vector
%  subtraction and a norm, Sec. 1.6 for the "do not take a square root you are
%  going to square" saving, Sec. 2.7 for Big-O and Sec. 4.6 for FLOPs -- so a
%  change to any of those counts propagates forward into both.
%
...
Within this unit, though, the numbering does run continuously from part to part:
