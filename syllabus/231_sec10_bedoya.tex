...
%    \officehours  -- Thursdays 3:00-4:00 PM, Kiely Hall 508 (Math lounge).
...
%--------------------------------------------------------- fill these in -----
\newcommand{\officehours}{Thursdays, 3:00--4:00 PM}
...
Office location & Kiely Hall 508, the Math lounge (Kiely Tower) \\
...
\begin{enumerate}
  ...
  \item \textbf{Office hours}, Thursdays 3:00--4:00 PM in Kiely Hall 508 ---
        the Math lounge, up in Kiely Tower. It is a good place to work: plenty
        of chalkboards and other people doing mathematics. \textbf{Email me
        beforehand} so I know to expect you. Come with a specific question or
        come with nothing and we will find one; you are not interrupting.
